  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="bbs">
        <h5>买家留言：</h5>
        <textarea
          placeholder="建议留言前先与商家沟通确认" class="remarks-cont"
          v-model="msg"
        ></textarea>
...
export default {
  ...
  methods: {
    ...
    changeDefault (address, addressInfo) {
      addressInfo.forEach(item => { // 全部的isDefault为0
        item.isDefault = 0
      })
      address.isDefault = 1 // 目标项目的isDefault为1
    },

    // 提交订单
    async submitOrder () {
      const { tradeNo } = this.orderInfo // 解构出交易编码
      const data = {
